...
## `vp pm config set vite-plus-pm-config-test-key wrong-value --location project`
...
The rejected project write did not change the home value.
...
The rejected project deletion did not remove the home value.
