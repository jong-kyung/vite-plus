...
## `cd packages/app && vp remove --recursive testnpm2`

reject unsupported recursive removal before changing any workspace
...
## `cd packages/app && vp remove --recursive --filter app --filter utils testnpm2`

filters do not make recursive removal supported
...
```
{"name":"root","private":true,"packageManager":"bun@1.4.0","workspaces":["packages/*"],"dependencies":{"testnpm2":"1.0.0"}}{"name":"app","version":"1.0.0","dependencies":{"testnpm2":"1.0.0"}}{"name":"utils","version":"1.0.0","dependencies":{"testnpm2":"1.0.0"}}{
  "lockfileVersion": 2,
  "configVersion": 1,
  "workspaces": {
    "": {
  ...
  "packages": {
    ...
    "testnpm2": ["testnpm2@1.0.0", "", {}, "sha512-8gdtqxKad+83Iog2v514VsHsSk/R+we9j5/9zX9tB+QC2ubvB06zJ08k0PSl5uzviXByEMiWm7EzSbBAh2GZ/w=="],
...
## `node -e 'for (const dir of ['\''.'\'', '\''packages/app'\'', '\''packages/utils'\'']) require('\''node:assert/strict'\'').equal(require(require.resolve('\''testnpm2/package.json'\'', {paths: [require('\''node:path'\'').resolve(dir)]})).version, '\''1.0.0'\'')'`
