# berry_recursive_update_from_child
...
## `cd packages/app && vp update --recursive --latest is-number@7.0.0 -- --mode skip-build`

recursive update changes every workspace manifest, not just lockfile resolutions
